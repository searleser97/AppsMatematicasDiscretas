    ...
    try:
        if opc == "1":
            ...
            if factores == True:
                ...
                print(Fore.RED + Style.BRIGHT + "Error: " + Style.RESET_ALL + "Numero fuera del rango de la criba")
                return 1
            factores.append(0)
            unique = []
            exponentes = []
            ...
            for i in range(2, 21):
                ...
                if (lodividio):
                    print(Fore.GREEN + Style.BRIGHT + str(i) + " -->", lodividio, Style.RESET_ALL)
                else:
                    print(i, "-->", lodividio)
            ...
            file.close()
            print("Los numeros primos se encuentran en el archivo primos.txt del actual directorio")
            ...
            if (base > 10):
                n = input("Ingrese el numero en base " + str(base) + " separado por comas: ")
            else:
            ...
            print(Fore.YELLOW + Style.BRIGHT + "(!) " + Style.RESET_ALL + "La opcion seleccionada no existe, intente de nuevo...")
            return 0
    except ValueError:
        print(Fore.RED + Style.BRIGHT + "Error: " + Style.RESET_ALL + "El valor introducido no fue valido, intente de nuevo...")
        menu(opc)
    except ZeroDivisionError:
        print(Fore.RED + Style.BRIGHT + "Error: " + Style.RESET_ALL + "Modulo o Division por cero, intente con un valor diferente de cero")
        menu(opc)
